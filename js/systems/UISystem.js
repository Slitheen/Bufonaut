...
export class UISystem {
    ...
    createGameplayArea() {
        ...
        if (!this.scene.player) {
            ...
            // Setup platform collision - treat same as ground collision
            if (this.platformBody) {
                this.scene.physics.add.collider(this.scene.player, this.platformBody, () => this.scene.collisionSystem.onPlayerLand(), null, this.scene);
            }
